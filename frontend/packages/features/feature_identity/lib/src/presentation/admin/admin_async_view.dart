...
/// visible instead of a bare exception string.
...
/// Label/value row used by the admin detail screens.
class AdminDetailRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: WmsSpacing.space2),
      child: Row(
