...
using Wms.Inventory.Infrastructure.Posting;
...
public static class InventoryInfrastructureExtensions
{
    ...
    public static IServiceCollection AddInventoryServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IStockCountQueries, StockCountQueries>();
        services.AddScoped<IStockRequestQueries, StockRequestQueries>();
        services.AddScoped<IIssueQueries, IssueQueries>();
        services.AddScoped<IWasteQueries, WasteQueries>();
        services.AddScoped<ISampleQueries, SampleQueries>();
        services.AddScoped<IReturnToVendorQueries, ReturnToVendorQueries>();
